  ...
  return (
    <div className="py-8">
      <div className="flex flex-col gap-4 px-14 pb-10">
        ...
        <p className="flex justify-center lg:justify-start text-sm text-left text-[#AAAAAA] lg-w-xs">
      ...
      <div className="lg:grid lg:grid-cols-3">
        {api.cards.map((card) => (
          <Card
            key={card.img}
            className="flex  my-6 mx-14 rounded-4xl pt-0 rounded-t-4xl lg:w-2xs"
          >
