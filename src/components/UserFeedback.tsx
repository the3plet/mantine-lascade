  ...
  return (
    <div className="py-8">
      <div className="flex flex-col gap-4 px-14 pb-10">
        ...
        <p className="flex justify-center lg:justify-start text-sm text-left text-[#AAAAAA] lg:w-md">
      ...
      <div className="lg:grid lg:grid-cols-4">
        {api.feedback.map((feed) => (
          <Card key={feed.id} className="mx-14 my-6 lg:my-0 py-10 lg:py-0 pb-4 lg:pb-0 rounded-4xl lg:w-2xs">
            <CardContent className="gap-4 flex flex-col lg:justify-center lg:h-full lg:py-4">
              <p className="text-white opacity-30 text-sm lg:text-lg">{feed.description}</p>
